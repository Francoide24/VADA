...
Música: Analiza la música de forma precisa, extrayendo datos sobre su tono y instrumentación.
...
instrumentacion: Lista de strings con los instrumentos detectados y/o descripción de la melodía (ej ["melodía electrónica suave", "piano"]). Si no hay instrumentación/melodía clara, usar una lista vacía [].
